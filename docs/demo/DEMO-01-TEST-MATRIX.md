...
|-------|-----------|-------|----------|
| Unit (domain) | Vitest | 117 | services/platform-service/src/**/*.spec.ts |
| Unit (packages) | Vitest | 72 | packages/*/src/**/*.spec.ts |
| Unit (frontend) | Vitest + RTL | 103 | apps/platform-admin-console/src/**/*.spec.tsx |
