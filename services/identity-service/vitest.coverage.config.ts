  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/domain/authorization-decision.ts',
        'src/application/commands/session-commands.ts',
        'src/application/commands/authorization-decision.command.ts',
