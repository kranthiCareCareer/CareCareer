 ...
 * Used for runtime database access in the platform-service.
 *
 * Implements the $transaction pattern: opens a connection, runs BEGIN,
 * executes the operation, then COMMIT or ROLLBACK.
 */
